...
1. Generate verification pairs
2. Create mel-spectrogram images
3. Train the fusion speaker verification model (SincNet + MobileNetV2)
4. Evaluate on clean, noisy, and filtered test sets
5. Ablation and performance analysis
